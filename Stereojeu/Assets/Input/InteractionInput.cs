...
public partial class @InteractionInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e21c5c79-f802-4041-a4de-367982ca8285"",
    ...
    ~@InteractionInput()
    {
        UnityEngine.Debug.Assert(!m_Game.enabled, "This will cause a leak and performance issues, InteractionInput.Game.Disable() has not been called.");
    }
    ...
    public struct GameActions
    {
        ...
        /// </summary>
        public GameActions(@InteractionInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
